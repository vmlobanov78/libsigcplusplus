  ...
  operator()(T_arg... _A_arg)
    {
      ...
      using t_type_bound = std::tuple<type_trait_take_t<typename unwrap_reference<T_bound>::type>...>;

      //TODO: The old generated code used type_trait_pass_t for start and type_trait_take_t for end,
      //but that looks like a mistake.
      //using tuple_type_args_take = std::tuple<type_trait_take_t<T_arg>...>;
      //using t_type_end = typename tuple_type_end<tuple_type_args_take, t_args_size - I_location>::type;
  ...
  operator()(T_arg... _A_arg)
    {
      ...
      using t_type_bound = std::tuple<type_trait_take_t<typename unwrap_reference<T_type>::type>...>;
