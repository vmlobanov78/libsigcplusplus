...
ifelse($1,0,[#ifndef DOXYGEN_SHOULD_SKIP_THIS
  ...
  struct deduce_result_type
    { typedef typename adaptor_type::template deduce_result_type<LIST(LOOP(type_trait_pass_t<T_arg%1>, eval($1)), type_trait_take_t<typename unwrap_reference<T_bound>::type>, FOR(eval($1+1),eval(CALL_SIZE-1),[type_trait_take_t<T_arg%1>,]))>::type type; };
ifelse($1,0,[#endif
],)dnl
